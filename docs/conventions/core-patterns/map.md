...
Примеры:
- `ProjectName\Web\Module\Project\Map\ProjectStatusTextMap`
- `ProjectName\Api\Module\Source\Map\SourceStatusTextMap`
...
namespace ProjectName\Web\Module\Project\Map;

use Symfony\Contracts\Translation\TranslatorInterface;
use ProjectName\Web\Module\Project\Enum\ProjectStatusEnum;
...
namespace ProjectName\Web\Module\Project\Mapper;

use ProjectName\Web\Module\Project\Enum\ProjectStatusEnum;
use ProjectName\Web\Module\Project\List\ProjectStatusList;
use ProjectName\Web\Module\Project\Map\ProjectStatusTextMap;
