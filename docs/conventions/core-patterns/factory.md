...
{ProjectName}\Common\Module\{ModuleName}\Application\UseCase\Command\{UseCase}\{Name}Factory
{ProjectName}\Common\Module\{ModuleName}\Application\UseCase\Query\{UseCase}\{Name}Factory
{ProjectName}\Common\Module\{ModuleName}\Application\Service\{ServiceName}\{Name}Factory
```
...
namespace ProjectName\Common\Module\Llm\Domain\Factory;

use ProjectName\Common\Module\Llm\Domain\Enum\ToolEnum;
use ProjectName\Common\Module\Llm\Domain\Enum\ToolTypeEnum;
use ProjectName\Common\Module\Llm\Domain\Service\ToolFunction\ToolFunctionRegistryInterface;
use ProjectName\Common\Module\Llm\Domain\ValueObject\ToolFunctionVo;
use ProjectName\Common\Module\Llm\Domain\ValueObject\ToolVo;
