...
Примеры:
- `ProjectName\Common\Module\Project\Domain\List\ProjectUserRolesList`
...
Примеры:
- `ProjectName\Web\Module\Project\List\FastFilterProjectStatusList`
- `ProjectName\Web\Module\User\List\FastFilterInvitationStatusList`
- `ProjectName\Web\Module\Source\List\FastFilterSourceStatusList`
...
- Не используем для запросов в БД или сложной логики — для этого создавайте [Query](../layers/application/query-handler.md).
...
namespace ProjectName\Web\Module\Project\List;
