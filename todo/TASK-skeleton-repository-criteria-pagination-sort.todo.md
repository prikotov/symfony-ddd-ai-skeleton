...
**PR:** будет создан как draft из `task/skeleton-repository-criteria-pagination-sort` в `epic/skeleton-module-ddd-scaffold`; после создания тимлид обновит ссылку.
